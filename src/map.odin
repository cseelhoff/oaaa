...
MapData :: struct {
	...
	adj_l2a:                 [Land_ID]bit_set[Air_ID;u8],
	air_l2a_2away:           [Land_ID]bit_set[Air_ID;u8],
	adj_l2l:                 [Land_ID]SA_L2L,
	adj_l2s:                 [Land_ID]SA_L2S,
	adj_l2s_2_away:          [Land_ID]SA_L2S_2_Away,
	//adj_a2a:            [Air_ID]SA_A2A,
	adj_a2l:                 [Air_ID]bit_set[Land_ID;u8],
	adj_a2s:                 [Air_ID]bit_set[Sea_ID;u8],
	...
	air_within_6_air_moves:  [Air_ID]bit_set[Air_ID;u16],
	air_within_5_air_moves:  [Air_ID]bit_set[Air_ID;u16],
	air_within_4_air_moves:  [Air_ID]bit_set[Air_ID;u16],
	air_within_3_air_moves:  [Air_ID]bit_set[Air_ID;u16],
	air_within_2_air_moves:  [Air_ID]bit_set[Air_ID;u16],
	air_within_1_air_moves:  [Air_ID]bit_set[Air_ID;u16],

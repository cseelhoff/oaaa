...
Transport_Load_Unit := [Idle_Army][Active_Ship]Active_Ship {
	.INF = {
		.TRANS_EMPTY_UNMOVED = .TRANS_1I_UNMOVED,
		.TRANS_EMPTY_2_MOVES = .TRANS_1I_2_MOVES,
		.TRANS_EMPTY_1_MOVES = .TRANS_1I_1_MOVES,
		.TRANS_EMPTY_0_MOVES = .TRANS_1I_0_MOVES,
		.TRANS_1I_UNMOVED = .TRANS_2I_2_MOVES,
		.TRANS_1I_2_MOVES = .TRANS_2I_2_MOVES,
		.TRANS_1I_1_MOVES = .TRANS_2I_1_MOVES,
		.TRANS_1I_0_MOVES = .TRANS_2I_0_MOVES,
		.TRANS_1I_UNLOADED = .TRANS_2I_UNLOADED,
		.TRANS_1A_UNMOVED = .TRANS_1I_1A_2_MOVES,
		.TRANS_1A_2_MOVES = .TRANS_1I_1A_2_MOVES,
		.TRANS_1A_1_MOVES = .TRANS_1I_1A_1_MOVES,
		.TRANS_1A_0_MOVES = .TRANS_1I_1A_0_MOVES,
		.TRANS_1A_UNLOADED = .TRANS_1I_1A_UNLOADED,
		.TRANS_1T_UNMOVED = .TRANS_1I_1T_2_MOVES,
		.TRANS_1T_2_MOVES = .TRANS_1I_1T_2_MOVES,
		.TRANS_1T_1_MOVES = .TRANS_1I_1T_1_MOVES,
		.TRANS_1T_0_MOVES = .TRANS_1I_1T_0_MOVES,
		.TRANS_1T_UNLOADED = .TRANS_1I_1T_UNLOADED,
		.TRANS_2I_2_MOVES = .TRANS_2I_2_MOVES,
		.TRANS_2I_1_MOVES = .TRANS_2I_1_MOVES,
		.TRANS_2I_0_MOVES = .TRANS_2I_0_MOVES,
		.TRANS_2I_UNLOADED = .TRANS_2I_UNLOADED,
		.TRANS_1I_1A_2_MOVES = .TRANS_1I_1A_2_MOVES,
		.TRANS_1I_1A_1_MOVES = .TRANS_1I_1A_1_MOVES,
		.TRANS_1I_1A_0_MOVES = .TRANS_1I_1A_0_MOVES,
		.TRANS_1I_1A_UNLOADED = .TRANS_1I_1A_UNLOADED,
		.TRANS_1I_1T_2_MOVES = .TRANS_1I_1T_2_MOVES,
		.TRANS_1I_1T_1_MOVES = .TRANS_1I_1T_1_MOVES,
		.TRANS_1I_1T_0_MOVES = .TRANS_1I_1T_0_MOVES,
	...
	.ARTY = {
		.TRANS_EMPTY_UNMOVED = .TRANS_1A_UNMOVED,
		.TRANS_EMPTY_2_MOVES = .TRANS_1A_2_MOVES,
		.TRANS_EMPTY_1_MOVES = .TRANS_1A_1_MOVES,
		.TRANS_EMPTY_0_MOVES = .TRANS_1A_0_MOVES,
		.TRANS_1I_UNMOVED = .TRANS_1I_UNMOVED,
		.TRANS_1I_2_MOVES = .TRANS_1I_1A_2_MOVES,
		.TRANS_1I_1_MOVES = .TRANS_1I_1A_1_MOVES,
		.TRANS_1I_0_MOVES = .TRANS_1I_1A_0_MOVES,
		.TRANS_1I_UNLOADED = .TRANS_1I_1A_UNLOADED,
		.TRANS_1A_UNMOVED = .TRANS_1A_UNMOVED,
		.TRANS_1A_2_MOVES = .TRANS_1A_2_MOVES,
		.TRANS_1A_1_MOVES = .TRANS_1A_1_MOVES,
		.TRANS_1A_0_MOVES = .TRANS_1A_0_MOVES,
		...
		.TRANS_1T_0_MOVES = .TRANS_1T_0_MOVES,
	...
	.TANK = {
		.TRANS_EMPTY_UNMOVED = .TRANS_1T_UNMOVED,
		.TRANS_EMPTY_2_MOVES = .TRANS_1T_2_MOVES,
		.TRANS_EMPTY_1_MOVES = .TRANS_1T_1_MOVES,
		.TRANS_EMPTY_0_MOVES = .TRANS_1T_0_MOVES,
		.TRANS_1I_UNMOVED = .TRANS_1I_1T_2_MOVES,
		.TRANS_1I_2_MOVES = .TRANS_1I_1T_2_MOVES,
		.TRANS_1I_1_MOVES = .TRANS_1I_1T_1_MOVES,
		.TRANS_1I_0_MOVES = .TRANS_1I_1T_0_MOVES,
		.TRANS_1I_UNLOADED = .TRANS_1I_1T_UNLOADED,
		.TRANS_1A_UNMOVED = .TRANS_1A_UNMOVED,
		.TRANS_1A_2_MOVES = .TRANS_1A_2_MOVES,
		.TRANS_1A_1_MOVES = .TRANS_1A_1_MOVES,
		.TRANS_1A_0_MOVES = .TRANS_1A_0_MOVES,
	...
	.AAGUN = {
		...
		.TRANS_1I_0_MOVES = .TRANS_1I_0_MOVES,

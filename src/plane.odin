...
// 	for land in Land_ID {
// 		move_land_plane_air(gc, land, plane) or_return
// 	}
// 	for sea in Sea_ID {
// 		move_sea_plane_air(gc, sea, plane) or_return
// 	}
// 	if gc.clear_needed do clear_move_history(gc)
// 	return true
// }

// move_land_plane_air :: proc(gc: ^Game_Cache, src_land: Land_ID, plane: Active_Plane) -> (ok: bool) {
...
// 	add_valid_land_plane_moves(gc, src_land, plane)
// 	for gc.active_planes[src_land][plane] > 0 {
// 		move_next_plane_in_to_air(gc, src_land, plane) or_return
// 	}
// 	return true
// }

// move_sea_plane_air :: proc(gc: ^Game_Cache, src_sea: Sea_ID, plane: Active_Plane) -> (ok: bool) {
// 	if gc.active_sea_planes[src_sea][plane] == 0 do return true
// 	refresh_plane_can_land_here(gc, plane)
// 	gc.valid_actions = {to_action(src_sea)}
// 	add_valid_sea_plane_moves(gc, src_sea, plane)
// 	for gc.active_planes[src_sea][plane] > 0 {
// 		move_next_plane_in_to_air(gc, src_sea, plane) or_return
// 	}
// 	return true
// }
...
// 	if card(gc.valid_actions) > 0 do return false
